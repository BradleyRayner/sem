...
public class App {
    ...
    public Department getDepartment(String dept_name)
    {
        try
        {
            ...
            String stmt = "SELECT dept_no, dept_name " +
                    "FROM departments " +
        ...
        {
            System.out.println("Failed to get by department");
            return null;
        }
    }
    public ArrayList<Employee> getSalariesByDepartment(Department dept)
    {
        try
        {
            ...
            String stmt = "SELECT employees.emp_no, employees.first_name, employees.last_name, salaries.salary "+
            ...
            ArrayList<Employee> salariesByDept = new ArrayList<Employee>();
            while (rset.next()) {
                Employee emp = new Employee();
                emp.emp_no = rset.getInt("employees.emp_no");
                emp.first_name = rset.getString("employees.first_name");
